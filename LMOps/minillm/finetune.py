            ...
            if args.save and args.save_interval and global_step % args.save_interval == 0 and step % args.gradient_accumulation_steps == 0:
                ...
                if args.model_parallel:
                    ...
                    if dist.get_rank() == 0:
                        ...
                        tokenizer.save_pretrained(save_dir_path)
                        # model.module.save_pretrained(save_dir_path, safe_serialization=False) # original
                        model.module.save_pretrained(save_dir_path, safe_serialization=True) # changed
                dist.barrier()
