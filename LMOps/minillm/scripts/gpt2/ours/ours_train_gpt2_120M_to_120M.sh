...
#SBATCH -c 16
#SBATCH --mem=64G
#SBATCH --output=/scratch/gaeunyim/minillm/results/gpt2/train/logs_120_to_120.out 
#SBATCH --error=/scratch/gaeunyim/minillm/results/gpt2/train/errors_120_to_120.out 
