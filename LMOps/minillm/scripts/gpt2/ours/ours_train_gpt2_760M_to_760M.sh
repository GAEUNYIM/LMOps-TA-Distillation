...
#SBATCH -c 16
#SBATCH --mem=64G
#SBATCH --output=/scratch/gaeunyim/minillm/results/gpt2/train/logs_760_to_760.out 
#SBATCH --error=/scratch/gaeunyim/minillm/results/gpt2/train/errors_760_to_760.out 
