...
#SBATCH -c 16
#SBATCH --mem=64G
#SBATCH --output=/scratch/gaeunyim/minillm/results/opt/train/logs_6.7B_to_1.3B.out
#SBATCH --error=/scratch/gaeunyim/minillm/results/opt/train/errors_logs_6.7B_to_1.3B.out
...
STUDENT_SIZE="1.3B"
INDEX_EXP="1"
CKPT_NAME="init-opt-${STUDENT_SIZE}"
CKPT="/scratch/gaeunyim/minillm/checkpoints/${CKPT_NAME}"
TEACHER_CKPT_NAME="minillm-opt-${TEACHER_SIZE}"
TEACHER_CKPT="/scratch/gaeunyim/minillm/checkpoints/${TEACHER_CKPT_NAME}"
# data
PROMPT_DATA_DIR="/scratch/gaeunyim/minillm/processed_data/dolly/prompt/opt/"
...
SAVE_PATH="/scratch/gaeunyim/minillm/results/opt/ckpt/${DISTILLED_NAME}"
# hp
GRAD_ACC=2
BATCH_SIZE=2
CHUNK_SIZE=8
