...
#SBATCH -c 4
#SBATCH --mem=16G
#SBATCH --output=/scratch/gaeunyim/LMOps-TA-Distillation/MiniLLM/minillm/results/opt/eval_main/dolly-512/distilled-opt-2.7B-to-1.3B_1/eval_1.3B.out 
#SBATCH --error=/scratch/gaeunyim/LMOps-TA-Distillation/MiniLLM/minillm/results/opt/eval_main/dolly-512/distilled-opt-2.7B-to-1.3B_1/errors/eval_1.3B.out
