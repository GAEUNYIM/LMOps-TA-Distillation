...
#SBATCH -c 16
#SBATCH --mem=64G
#SBATCH --output=/scratch/gaeunyim/minillm/results/gpt2/train/logs_340_to_340.out 
#SBATCH --error=/scratch/gaeunyim/minillm/results/gpt2/train/errors_340_to_340.out 
